...
-- Prisma's `@@unique` may have created either a CONSTRAINT or a raw
-- UNIQUE INDEX depending on version, so try both forms; either being
-- absent on the running DB is harmless.
ALTER TABLE "team_members"
